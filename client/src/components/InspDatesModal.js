        ...
        <Form noValidate validated={validated} onSubmit={handleValidation}>
          ...
          <Modal.Body>
            ...
            <Form.Group className="mb-3" controlId="ptandcrossing">
                ...
                <Form.Control.Feedback type="invalid">This field is mandatory</Form.Control.Feedback>
                <Form.Control type="date" required name="ptandcrossing" placeholder="DateRange" value={props.rest.ptandcrossing} onChange={props.handleOnChange} />
                <Form.Control.Feedback type="invalid">This field is mandatory</Form.Control.Feedback>
            </Form.Group>
            <Form.Group className="mb-3" controlId="electricGen">
                <Form.Label>Electrical Gen. Inspection Date</Form.Label>
                <Form.Control type="date" required name="electricGen" placeholder="DateRange" value={props.rest.electricGen} onChange={props.handleOnChange} />
                <Form.Control.Feedback type="invalid">This field is mandatory</Form.Control.Feedback>
            </Form.Group>
            <Form.Group className="mb-3" controlId="trd">
                <Form.Label>TRD Inspection Date</Form.Label>
                <Form.Control type="date" required name="trd" placeholder="DateRange" value={props.rest.trd} onChange={props.handleOnChange} />
                <Form.Control.Feedback type="invalid">This field is mandatory</Form.Control.Feedback>
            </Form.Group>
            <Form.Group className="mb-3" controlId="trackpwi">
                <Form.Label>Track Inspection with PWI Date</Form.Label>
                <Form.Control type="date" required name="trackpwi" placeholder="DateRange" value={props.rest.trackpwi} onChange={props.handleOnChange} />
                <Form.Control.Feedback type="invalid">This field is mandatory</Form.Control.Feedback>
            </Form.Group>
            <Form.Group className="mb-3" controlId="ssd">
                <Form.Label>SSD Inspection Date</Form.Label>
                <Form.Control type="date" required name="ssd" placeholder="DateRange" value={props.rest.ssd} onChange={props.handleOnChange} />
                <Form.Control.Feedback type="invalid">This field is mandatory</Form.Control.Feedback>
            </Form.Group>
          </Modal.Body>
          <Modal.Footer>
